...
- **[Part 2: VLANs, Bonding, and Network Segregation](https://blog.saneax.in/tech/learn-datacenter-networking-gns3-part2/)** — VLANs, NIC bonding modes, LACP, bridge isolation
- **[Part 3: iPerf3, Fiber, and Juniper — Testing Your Datacenter Network Like a Pro](https://blog.saneax.in/tech/learn-datacenter-networking-gns3-part3/)**
...
Yeah, I'll be honest — I've installed GNS3 on all four platforms. And I hate saying this but Windows is the smoothest. Go figure. The all-in-one installer genuinely works. Linux requires more fiddling with permissions. macOS needs you to okay kernel extensions in Security settings. But they all get there eventually.
...
**Next in the series:** [Part 3: iPerf3, Fiber, and Juniper — Testing Your Datacenter Network](https://blog.saneax.in/tech/learn-datacenter-networking-gns3-part3/) covers what happens after you've built your network — measuring actual throughput, diagnosing fiber issues, and using Juniper DOM readings.
...
Part 2 is [live](https://blog.saneax.in/tech/learn-datacenter-networking-gns3-part2/) with a full outline — VLANs, all 7 bonding modes, LACP, and Juniper switch-side config. Part 3 is also [live](https://blog.saneax.in/tech/learn-datacenter-networking-gns3-part3/) covering iPerf3 and fiber testing. Subscribe via [RSS](https://blog.saneax.in/index.xml) to catch updates.
